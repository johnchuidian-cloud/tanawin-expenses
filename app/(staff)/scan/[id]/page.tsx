  ...
  if (!receipt) {
    return (
      <div className="px-5 py-10 flex flex-col items-center text-center">
        ...
        <Link href="/scan" className="btn btn-sm mt-4">
          Back to scan
        </Link>
      </div>
    );
    ...
    <div className="pb-6">
      ...
      <div className="px-5 pt-4">
        ...
        >
          {recon.status === "reconciled" ? (
            ...
            <AlertCircle className="w-4 h-4 text-ink-500 flex-shrink-0 mt-0.5" />
          )}
      ...
      <div className="px-5 pt-4">
        <div className="flex items-baseline justify-between mb-2">
          ...
          <Link
            href={`/new?receiptId=${receipt.id}&vendor=${encodeURIComponent(receipt.vendor)}&date=${encodeURIComponent(receipt.date)}`}
        ...
        {linkedEntries.length === 0 ? (
          <p className="text-xs text-ink-500">
            No line items yet. Tap &ldquo;Add line item&rdquo; to start.
          </p>
        ) : (
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-ink-500 mt-0.5">
                      ...
                      {staffCategoryLabel(entry.category)}
                    </p>
                  </div>
